...
class TrainingPlanBuilder:
    ...
    def build(
        ...
        *,
        ...
        data_eligibility_assessments: list[tuple[str, DataEligibilityResult]],
        data_snapshot_ids: list[str],
        label_versions: list[str],
    ) -> TrainingPlan:
        ...
        if not data_snapshot_ids or not label_versions:
        ...
        windows = TrainingWindowSpec(
            ...
            training_window_ids=self.config.iteration.default_training_window_ids,
            validation_window_ids=self.config.iteration.default_validation_window_ids,
        ...
        return TrainingPlan(
            ...
            sample_weight_policy=strategy.parameters.get("sample_weight_policy", {}),
