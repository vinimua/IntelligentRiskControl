...
async def lifespan(app: FastAPI):
    ...
    # P2: 初始化持久化 checkpointer
    from .services.workflow.checkpointer_manager import init_checkpointer, shutdown_checkpointer
    await init_checkpointer(settings)
    logger.info("checkpointer_initialized", mode=settings.workflow_checkpointer)
