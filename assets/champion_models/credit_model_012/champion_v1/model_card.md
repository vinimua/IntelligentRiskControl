# credit_model_012 / champion_v1 模型卡
...
最终参数：`{"class_weight": "balanced_subsample", "max_depth": 20, "max_features": "sqrt", "min_samples_leaf": 40, "n_estimators": 800}`

校准器：`Isotonic`

阈值：`0.03048780487804878`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.95681016
- KS：0.78659770
- Bad Recall：0.91231464
- Brier：0.02037109
- ECE：0.00470231
