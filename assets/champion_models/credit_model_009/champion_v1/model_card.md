# credit_model_009 / champion_v1 模型卡
...
最终参数：`{"class_weight": "balanced_subsample", "max_depth": 6, "max_features": "sqrt", "min_samples_leaf": 20, "n_estimators": 300}`

校准器：`Isotonic`

阈值：`0.0625`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.97850863
- KS：0.86204847
- Bad Recall：0.88910380
- Brier：0.01509265
- ECE：0.00498663
