# credit_model_027 / champion_v1 模型卡
...
最终参数：`{"class_weight": null, "feature_fraction": 0.6, "learning_rate": 0.05, "max_depth": 4, "min_child_samples": 10, "n_estimators": 600, "num_leaves": 12}`

校准器：`Isotonic`

阈值：`0.03488372093023256`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.98208565
- KS：0.86970161
- Bad Recall：0.95035461
- Brier：0.01170267
- ECE：0.00325969
