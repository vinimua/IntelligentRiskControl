# credit_model_024 / champion_v1 模型卡
...
最终参数：`{"colsample_bytree": 0.75, "learning_rate": 0.015, "max_depth": 5, "min_child_weight": 15, "n_estimators": 700, "scale_pos_weight": 1.0, "subsample": 0.85}`

校准器：`Isotonic`

阈值：`0.04838709533214569`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.96168217
- KS：0.79829939
- Bad Recall：0.88974855
- Brier：0.01724899
- ECE：0.00472271
