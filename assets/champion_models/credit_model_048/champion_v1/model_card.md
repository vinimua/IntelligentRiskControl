# credit_model_048 / champion_v1 模型卡
...
最终参数：`{"interactions": 6, "learning_rate": 0.06, "max_bins": 256, "min_samples_leaf": 50, "outer_bags": 9}`

校准器：`Isotonic`

阈值：`0.05555555555555555`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.96233282
- KS：0.80405718
- Bad Recall：0.86911670
- Brier：0.01649919
- ECE：0.00241438
