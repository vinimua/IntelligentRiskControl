# credit_model_046 / champion_v1 模型卡
...
最终参数：`{"interactions": 11, "learning_rate": 0.05, "max_bins": 128, "min_samples_leaf": 30, "outer_bags": 10}`

校准器：`Isotonic`

阈值：`0.05217391304347826`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.95794576
- KS：0.77051494
- Bad Recall：0.86718246
- Brier：0.01804162
- ECE：0.00305784
