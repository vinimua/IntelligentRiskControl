# credit_model_017 / champion_v1 模型卡
...
最终参数：`{"colsample_bytree": 0.7, "learning_rate": 0.03, "max_depth": 3, "min_child_weight": 5, "n_estimators": 400, "scale_pos_weight": 1.0, "subsample": 0.75}`

校准器：`Isotonic`

阈值：`0.04123711213469505`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.98340586
- KS：0.87898541
- Bad Recall：0.94326241
- Brier：0.01123821
- ECE：0.00399053
