# credit_model_007 / champion_v1 模型卡
...
最终参数：`{"C": 0.3, "class_weight": null, "max_iter": 2000, "solver": "lbfgs"}`

校准器：`Isotonic`

阈值：`0.0196078431372549`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.98246230
- KS：0.88240658
- Bad Recall：0.94519665
- Brier：0.01063666
- ECE：0.00338567
