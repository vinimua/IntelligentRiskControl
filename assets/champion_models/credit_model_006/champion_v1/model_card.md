# credit_model_006 / champion_v1 模型卡
...
最终参数：`{"C": 1.0, "class_weight": null, "max_iter": 2000, "solver": "lbfgs"}`

校准器：`Isotonic`

阈值：`0.045454545454545456`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.95630041
- KS：0.77177867
- Bad Recall：0.88007737
- Brier：0.01811717
- ECE：0.00407198
