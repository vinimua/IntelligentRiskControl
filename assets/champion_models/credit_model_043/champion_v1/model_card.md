# credit_model_043 / champion_v1 模型卡
...
最终参数：`{"auto_class_weights": "Balanced", "depth": 8, "iterations": 1000, "l2_leaf_reg": 6, "learning_rate": 0.08, "random_strength": 0.8}`

校准器：`Isotonic`

阈值：`0.03389830508474576`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.98242016
- KS：0.87325688
- Bad Recall：0.93230174
- Brier：0.01146905
- ECE：0.00312945
