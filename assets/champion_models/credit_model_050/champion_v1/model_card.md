# credit_model_050 / champion_v1 模型卡
...
最终参数：`{"interactions": 15, "learning_rate": 0.05, "max_bins": 128, "min_samples_leaf": 30, "outer_bags": 10}`

校准器：`Isotonic`

阈值：`0.03636363636363636`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.95692240
- KS：0.76832147
- Bad Recall：0.85106383
- Brier：0.01798860
- ECE：0.00446218
