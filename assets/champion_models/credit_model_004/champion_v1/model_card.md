# credit_model_004 / champion_v1 模型卡

## 身份

- 模型角色：Champion
- 算法族：LogisticRegression
- 特征策略：F04
- 随机种子：2026004
...
最终参数：`{"C": 0.05, "class_weight": "balanced", "max_iter": 2000, "solver": "lbfgs"}`

校准器：`Isotonic`

阈值：`0.10526315789473684`，分数空间 `calibrated_pd`，比较符 `>=`。
