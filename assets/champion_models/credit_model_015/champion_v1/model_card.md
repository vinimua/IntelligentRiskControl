# credit_model_015 / champion_v1 模型卡
...
最终参数：`{"class_weight": "balanced_subsample", "max_depth": 16, "max_features": "sqrt", "min_samples_leaf": 20, "n_estimators": 700}`

校准器：`Isotonic`

阈值：`0.03896103896103896`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.98072345
- KS：0.86975191
- Bad Recall：0.92005158
- Brier：0.01405172
- ECE：0.00536247
