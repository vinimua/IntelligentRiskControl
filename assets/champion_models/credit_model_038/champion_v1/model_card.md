# credit_model_038 / champion_v1 模型卡
...
最终参数：`{"auto_class_weights": null, "depth": 5, "iterations": 600, "l2_leaf_reg": 5, "learning_rate": 0.02, "random_strength": 1.0}`

校准器：`Isotonic`

阈值：`0.060240963855421686`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.95615241
- KS：0.76913251
- Bad Recall：0.85815603
- Brier：0.01815246
- ECE：0.00335376
