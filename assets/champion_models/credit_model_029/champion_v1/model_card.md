# credit_model_029 / champion_v1 模型卡
...
最终参数：`{"class_weight": null, "feature_fraction": 0.7, "learning_rate": 0.03, "max_depth": 5, "min_child_samples": 20, "n_estimators": 400, "num_leaves": 15}`

校准器：`Isotonic`

阈值：`0.043478260869565216`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.95293257
- KS：0.76242925
- Bad Recall：0.86202450
- Brier：0.01879860
- ECE：0.00369414
