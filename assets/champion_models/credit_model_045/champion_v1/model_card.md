# credit_model_045 / champion_v1 模型卡
...
最终参数：`{"interactions": 10, "learning_rate": 0.04, "max_bins": 256, "min_samples_leaf": 20, "outer_bags": 8}`

校准器：`Isotonic`

阈值：`0.011764705882352941`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.98645829
- KS：0.88536357
- Bad Recall：0.95099936
- Brier：0.01054519
- ECE：0.00366688
