# credit_model_023 / champion_v1 模型卡
...
最终参数：`{"colsample_bytree": 0.6, "learning_rate": 0.05, "max_depth": 2, "min_child_weight": 3, "n_estimators": 600, "scale_pos_weight": 1.0, "subsample": 0.7}`

校准器：`Isotonic`

阈值：`0.04395604506134987`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.96239592
- KS：0.80350741
- Bad Recall：0.87814313
- Brier：0.01701789
- ECE：0.00398262
