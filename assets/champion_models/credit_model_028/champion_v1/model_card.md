# credit_model_028 / champion_v1 模型卡
...
最终参数：`{"class_weight": "balanced", "feature_fraction": 0.95, "learning_rate": 0.04, "max_depth": 9, "min_child_samples": 100, "n_estimators": 1000, "num_leaves": 48}`

校准器：`Isotonic`

阈值：`0.0847457627118644`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.98202446
- KS：0.87449526
- Bad Recall：0.92198582
- Brier：0.01201752
- ECE：0.00399504
