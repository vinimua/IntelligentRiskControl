# credit_model_040 / champion_v1 模型卡
...
最终参数：`{"auto_class_weights": null, "depth": 7, "iterations": 800, "l2_leaf_reg": 8, "learning_rate": 0.015, "random_strength": 1.5}`

校准器：`Isotonic`

阈值：`0.058823529411764705`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.96346025
- KS：0.80281726
- Bad Recall：0.87556415
- Brier：0.01703017
- ECE：0.00415079
