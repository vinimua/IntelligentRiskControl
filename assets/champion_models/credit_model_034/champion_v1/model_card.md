# credit_model_034 / champion_v1 模型卡
...
最终参数：`{"class_weight": null, "feature_fraction": 0.8, "learning_rate": 0.02, "max_depth": 7, "min_child_samples": 30, "n_estimators": 500, "num_leaves": 31}`

校准器：`Isotonic`

阈值：`0.05333333333333334`，分数空间 `calibrated_pd`，比较符 `>=`。

## W1 健康指标

- ROC-AUC：0.95745486
- KS：0.79671284
- Bad Recall：0.87491941
- Brier：0.01757856
- ECE：0.00395595
