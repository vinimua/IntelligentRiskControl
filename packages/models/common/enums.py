...
class RiskGuardrailCode(str, Enum):
    OVERFITTING = "OVERFITTING"
    DATA_LEAKAGE = "DATA_LEAKAGE"
    CONCEPT_DRIFT_MISDIAGNOSIS = "CONCEPT_DRIFT_MISDIAGNOSIS"
    ITERATION_OSCILLATION = "ITERATION_OSCILLATION"
    EXPLAINABILITY_LOSS = "EXPLAINABILITY_LOSS"
    SAMPLE_SELECTION_BIAS = "SAMPLE_SELECTION_BIAS"
    CUMULATIVE_DEGRADATION = "CUMULATIVE_DEGRADATION"


class GuardrailCoverageStatus(str, Enum):
